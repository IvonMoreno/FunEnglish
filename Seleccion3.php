  ...
  band=0;
    for(i=0;i<ctrl.length;i++){
        if(ctrl[i].checked ){
            ...
            // clearTimeout(x); 
            window.location.href="Dtos.php?variable2=3";
            ...
            window.location.href="Seleccion4.php";
            }
...
<center>
  <div id="div" >
    <form name="frmSO">
     ...
     <h2>Buenas noches</h2>
     <p>
  <audio src="Audios/good night.mp3" controls></audio>
   &nbsp; &nbsp; &nbsp;
  <img src="Imagenes/Tortuga1.png" width="30px">
  <audio src="Audios/04good nightL.mp3" controls></audio> 
</p>
       <label class="checkeable">
        <input type="radio"  name="tres" value="1" >
        <img src="Imagenes/gn2.png">
       </label>
      <label class="checkeable">
       <input type="radio"  name="tres" value="tres" > <img  src="Imagenes/ga.jpg">
      </label>
         <p>
          <input id="centrar" type="button" value="Verificar"   onclick="getRadioButtonSelectedValue(document.frmSO.tres)" />
        </p> 
 </form>
</div>
</center>
